...
describe("calculateTime function", () => {
  ...
  test("calculates time for zero seconds", async () => {
    ...
    expect(difference).toBeLessThan(1000);//5
  }, 1000);
});
